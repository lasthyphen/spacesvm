...
import (
	...
	runner_sdk "github.com/lasthyphen/dijets-network-runner/client"
	...
	"github.com/lasthyphen/spacesvm/client"
	"github.com/lasthyphen/spacesvm/parser"
...
func init() {
	...
	flag.StringVar(
		...
		"dijetsnode-path",
		"",
		"dijetsnode executable path",
	)
	flag.StringVar(
		&pluginDir,
		"dijetsnode-plugin-dir",
		"",
		"dijetsnode plugin directory",
	)
	flag.StringVar(
		&vmGenesisPath,
		"vm-genesis-path",
